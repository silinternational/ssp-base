Several SPs, a hub (a combined IdP and SP) and some IdPs get spun up by docker compose.  In order for this to work, you will need to edit your hosts file to include entries for the following domains ...
* ssp-sp1.local
* ssp-sp2.local
* ssp-sp3.local
* ssp-sp4.local
