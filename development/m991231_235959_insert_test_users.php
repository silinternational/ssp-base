...
class m991231_235959_insert_test_users extends Migration
{
    ...
    public function safeUp()
    {
        ...
        $users = [
            ...
            /**
             * User: `has_backupcode_mgr_recovery_contact`
             * Should match entry in `development/idp4-local/config/authsources.php`
             */
            [
                2,
                '49276',
                'has_backupcode_mgr_recovery_contact',
                'has_backupcode_mgr_recovery_contact@example.com',
                'yes',
                $later,
                $later,
                $later,
                ...
                'yes',
                'no',
                '4927f678-6d1c-423f-a094-46c6b56f7bc5',
            ],
        ];
        $this->batchInsert(
            '{{user}}',
        ...
        $passwords = [
            [1, 1, $now, $nextYear, $nextYear, password_hash('sildisco_password', PASSWORD_BCRYPT)],
            [2, 2, $now, $nextYear, $nextYear, password_hash('a', PASSWORD_BCRYPT)],
        ];
        $this->batchInsert(
            '{{password}}',
