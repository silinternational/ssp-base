...
return [
    ...
    'http://ssp-hub-sp.local:8081' => [
        ...
        'name' => "SP Local",
        'AssertionConsumerService' => 'http://ssp-hub-sp.local:8081/module.php/saml/sp/saml2-acs.php/ssp-hub-custom-port',
        'SingleLogoutService' => 'http://ssp-hub-sp.local:8081/module.php/saml/sp/saml2-logout.php/ssp-hub-custom-port',
    ...
    'http://ssp-hub-sp2.local:8082' => [
        'AssertionConsumerService' => 'http://ssp-hub-sp2.local:8082/module.php/saml/sp/saml2-acs.php/ssp-hub-custom-port',
        'SingleLogoutService' => 'http://ssp-hub-sp2.local:8082/module.php/saml/sp/saml2-logout.php/ssp-hub-custom-port',
        'IDPList' => [
            'http://ssp-hub-idp2.local:8086',
        ],
